...
data_files = {'train': '../../RACE_PLUS_ORDER/train_utf8_3.csv',
              'test': '../../RACE_PLUS_ORDER/test_utf8_3.csv', 'val': '../../RACE_PLUS_ORDER/val_utf8_3.csv'}  # training data generated by teacher model
