...
model_name = "./llama-2-13b-chat-hf"  # your teacher model
...
prompt = 'Suppose you are a high school teacher who needs to explain reading comprehension questions to students. Now there is a reading comprehension question, and the correct answer is given you. Please analyze the reasons why students mistakenly chose other answers first and give a rationale to explain the correct answer finally.\n' \
...
dataset = load_dataset('csv', data_files='./MCTEST/train.csv')  # your MMRC datasets
...
with open('./MCTEST_PLUS/train.csv', 'w', newline='', encoding='utf-8') as file:
